			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					...
					<th class='text-right'>Accione</th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><a href="#" data-toggle="tooltip" data-placement="top" title="<i class='glyphicon glyphicon-phone'></i> <?php echo $direccion_cliente;?><br><i class='glyphicon glyphicon-envelope'></i>  <?php echo $email_cliente;?>" ><?php echo $nombre_cliente;?></a></td>
