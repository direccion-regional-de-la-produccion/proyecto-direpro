...
use PHPMailer\PHPMailer\Exception;
 $connect = mysqli_connect("localhost","root","","direpro");
//$selectDb= mysqli_select_db($connect,"bd_dire_2");
$email=$_REQUEST["email"];
$query=mysqli_query($connect,"select * from users where user_email='$email'");
...
$mail = new PHPMailer();
  ...
  $mail->isHTML(true);
  $mail->Subject = "Password recuperada";
  $mail->Body = "<i>Tu contraseña es :</i>".$row["user_password_hash"];
